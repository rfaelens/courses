...
output: rmarkdown::ioslides_presentation
...
## About this deck
Slides for a course about pharmacometric simulations, given at KULeuven on 14-Nov-2025.
Available on github at https://github.com/rfaelens/courses/ and live at https://rfaelens.shinyapp.io/kul2025
...
```{r }
knitr::include_graphics("phd_in_news.png")
```
...
## Learning objectives
* Understand the role of simulations in _Modeling & simulation_
* Know the difference between _population simulation_ and _clinical trial simulation_
* Select the appropriate simulation for a given question
